...
public class AstronomyService extends BaseService {
	 ...
	 */
	public AstronomyService(String accessKey, String secretKey)
	...
	public List<AstronomyLocation> getAstronomicalInfo(
			AstronomyObjectType objectType, LocationId placeId,
			TADDateTime startDate) throws Exception {
	...
	public List<AstronomyLocation> getAstronomicalInfo(
			AstronomyObjectType objectType, LocationId placeId,
			TADDateTime startDate, TADDateTime endDate) throws Exception {
